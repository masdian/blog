...
Karena terdapat `NA` pada peubah `country`, maka **R** menampilkan pesan kesalahan (*error*) sekaligus saran perbaikannya. Berikut adalah sintaks untuk mengatasi masalah tersebut.
